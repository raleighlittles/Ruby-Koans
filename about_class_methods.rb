...
class AboutClassMethods < Neo::Koan
  ...
  def test_classes_and_instances_do_not_share_instance_variables
    ...
    # Nothing was ever assigned to Dog.name (only to fido.name) and since classes and instances don't share instance
    # variables, there was nothing ever assigned for the 'name' instance variable for the dog class
  end
  ...
  # --------------- ANS  ----------------------
  # I prefer the first way, in general. I think the former is a clearer expression as a whole.
